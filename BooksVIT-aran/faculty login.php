...
<H2 align='center' style='font-family:BankGothic Lt bt;'><b>Faculty Login</b>
...
<tr>
	...
	<th width='40%' align='left'><input type='text' name='user' id='user' required=''> </th>
</tr>
<tr>
...
<tr>
	...
	<th width='40%' align='left'><input type='password' name='pass' required=''></th>
</tr>
<tr>
	<th width='20%' align='right'><button class='site-btn'type="submit" id='btn' value='Login'>Login</button></th>
	<th width='40%' align='left'><button class='site-btn' type="reset">Clear</button></th>
</tr>

<tr>
	<th width='20%' align='left'><a href='forgotpass.php'>Forgot Password</a></th>
